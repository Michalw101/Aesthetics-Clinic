...
export default function App() {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      toast.loading("מבצע תשלום מאובטח...", {
        id: "checkout",
        position: "top-center",
      });
      ...
      const msg =
        error instanceof Error
          ? error.message
          : "חלה שגיאה בביצוע ההזמנה. אנא נסי שוב.";
  ...
  return (
    <div
      className="min-h-screen bg-brand-beige text-brand-dark font-sans selection:bg-brand-gold/30"
      dir="rtl"
    >
            ...
            <div className="hidden md:flex items-center gap-6 text-sm font-medium tracking-wide uppercase">
              <button
                ...
                className={cn(
                  ...
                  currentPage === "home" && "text-brand-gold",
                )}
              >
                ראשי
              </button>
              <button
                ...
                className={cn(
                  "hover:text-brand-gold transition-colors",
                  currentPage === "treatments" && "text-brand-gold",
                )}
              >
                טיפולים
              </button>
              <button
                ...
                className={cn(
                  "hover:text-brand-gold transition-colors",
                  currentPage === "store" && "text-brand-gold",
                )}
              >
                חנות
              </button>
              <button
                ...
                className={cn(
                  "hover:text-brand-gold transition-colors",
                  currentPage === "booking" && "text-brand-gold",
                )}
              >
                קביעת תורים
              </button>
              <button
                ...
                className={cn(
                  "hover:text-brand-gold transition-colors",
                  currentPage === "blog" && "text-brand-gold",
                )}
              >
                בלוג
              </button>
              <button
                ...
                className={cn(
                  "hover:text-brand-gold transition-colors",
                  currentPage === "consultation" && "text-brand-gold",
                )}
              >
                ייעוץ אישי
              </button>
              ...
              {isAdmin && (
                <button
                  ...
                  className={cn(
                    "flex items-center gap-1 text-brand-gold font-bold transition-colors",
                    currentPage === "admin" && "underline underline-offset-4",
                  )}
                >
            ...
            {user ? (
              <div className="flex items-center gap-3">
                <button
                  ...
                  className={cn(
                    "text-xs font-bold hover:text-brand-gold transition-colors hidden sm:inline",
                    currentPage === "profile"
                      ? "text-brand-gold"
                      : "text-brand-dark/60",
                  )}
      ...
      <footer className="bg-white border-t border-brand-gold/10 py-12 px-6 mt-20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="space-y-4">
            <h3 className="text-xl serif font-semibold text-brand-gold">
              Aesthetics Clinic
            </h3>
            <p className="text-sm text-brand-dark/60 leading-relaxed">
              הקליניקה המובילה לאסתטיקה וטיפוח העור. אנחנו משלבים טכנולוגיה
              מתקדמת עם יחס אישי ומקצועי.
            </p>
          </div>
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-brand-dark/60">
              <li>
                <button onClick={() => navigateTo("home")}>ראשי</button>
              </li>
              <li>
              ...
              <li>
                <button onClick={() => navigateTo("store")}>חנות מוצרים</button>
              </li>
              <li>
              ...
              <li>
                <button onClick={() => navigateTo("blog")}>בלוג</button>
              </li>
            </ul>
          </div>
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-brand-dark/60">
              <li className="flex items-center gap-2">
                <MapPin size={14} /> רחוב המלכים 12, תל אביב
              </li>
              <li className="flex items-center gap-2">
                <Phone size={14} /> 03-1234567
              </li>
              <li className="flex items-center gap-2">
                <Clock size={14} /> א'-ה' 09:00-19:00
              </li>
            </ul>
          </div>
          <div className="space-y-4">
    ...
    >
        ...
        <div className="relative z-10 text-center space-y-8 px-6 max-w-4xl">
          ...
          >
            <h2 className="text-6xl md:text-8xl serif font-light tracking-tight text-brand-dark leading-tight">
              יופי שמתחיל <br />{" "}
              <span className="text-brand-gold italic">מבפנים</span>
            </h2>
          </motion.div>
          <motion.p
            initial={{ y: 30, opacity: 0 }}
          ...
          >
            קליניקת Aesthetics מציעה את הטיפולים המתקדמים ביותר בעולם האסתטיקה,
            בשילוב טכנולוגיה חדשנית ויחס אישי לכל מטופלת.
          </motion.p>
          <motion.div
            initial={{ y: 30, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
      ...
      <section className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12">
        <div className="text-center space-y-4">
          ...
          <p className="text-sm text-brand-dark/60 leading-relaxed">
            הצוות שלנו מורכב ממומחים בעלי ניסיון רב בתחום האסתטיקה והקוסמטיקה.
          </p>
        </div>
        <div className="text-center space-y-4">
          <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto shadow-md text-brand-gold">
          ...
          <p className="text-sm text-brand-dark/60 leading-relaxed">
            אנחנו משתמשים במכשור החדיש ביותר בעולם כדי להבטיח תוצאות מושלמות.
          </p>
        </div>
        <div className="text-center space-y-4">
          <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto shadow-md text-brand-gold">
          ...
          <p className="text-sm text-brand-dark/60 leading-relaxed">
            כל מטופלת מקבלת תוכנית טיפולים מותאמת אישית לצרכים ולמטרות שלה.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white py-24 px-6">
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            <h2 className="text-4xl serif font-semibold">
              הטיפולים הפופולריים שלנו
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={idx}
                className="group cursor-pointer overflow-hidden rounded-3xl relative aspect-[3/4]"
              >
                <img
                  src={t.img}
                  alt={t.title}
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-brand-dark/80 to-transparent flex flex-col justify-end p-8 text-white">
                  ...
                  <p className="text-sm opacity-0 group-hover:opacity-100 transition-opacity mt-2">
                    למידע נוסף והזמנה &larr;
                  </p>
                </div>
              </div>
            ))}
...
function TreatmentsPage({
  ...
  user: any;
  profile: any;
  onAddReview: (d: any) => void;
}) {
  const defaultTreatments = [
    {
      id: "1",
      name: "טיפול פנים עמוק",
      desc: "ניקוי יסודי של עור הפנים, הוצאת קומדונים והחדרת לחות.",
      price: "₪350",
    },
    {
      id: "2",
      name: "מזותרפיה",
      desc: "טיפול לחידוש מרקם העור, טשטוש צלקות וקמטוטים.",
      price: "₪600",
    },
    {
      id: "3",
      name: "פילינג כימי",
      desc: "קילוף מבוקר של שכבות העור לחידוש והבהרה.",
      price: "₪450",
    },
    {
      id: "4",
      name: "טיפול אנטי-אייג'ינג",
      desc: "שילוב טכנולוגיות להרמה ומיצוק עור הפנים.",
      price: "₪550",
    },
  ];

  const displayTreatments =
    clinicTreatments.length > 0 ? clinicTreatments : defaultTreatments;
  const [selectedTreatment, setSelectedTreatment] = useState<any>(null);
  const [reviewForm, setReviewForm] = useState({ rating: 5, comment: "" });

  const getTreatmentStats = (treatmentName: string) => {
    const treatmentReviews = reviews.filter(
      (r) => r.treatmentId === treatmentName && r.status === "approved",
    );
    ...
    >
      <div className="text-center space-y-4">
        ...
        <p className="text-brand-dark/60">
          גלי את מגוון הטיפולים המקצועיים שלנו ומה הלקוחות חושבות
        </p>
      </div>
      ...
      <div className="grid gap-6">
        {displayTreatments.map((t, idx) => {
          ...
          return (
            <div
              key={t.id || idx}
              className="bg-white p-8 rounded-3xl border border-brand-gold/10 flex flex-col md:flex-row justify-between items-center gap-6 hover:shadow-xl transition-shadow"
            >
              <div className="space-y-2 text-center md:text-right flex-1">
                <div className="flex items-center justify-center md:justify-start gap-2 mb-2">
                  <div className="flex text-brand-gold">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        ...
                        size={14}
                        fill={
                          i < Math.floor(Number(stats.rating))
                            ? "currentColor"
                            : "none"
                        }
                      />
                  ...
                  <span className="text-xs font-bold text-brand-gold">
                    {stats.rating} ({stats.count} ביקורות)
                  </span>
                </div>
                <h3 className="text-2xl serif font-medium text-brand-gold">
                  {t.name}
                </h3>
                ...
                <div className="pt-4 flex flex-wrap justify-center md:justify-start gap-4">
                  ...
                  {reviews.filter(
                    (r) => r.treatmentId === t.name && r.status === "approved",
                  ).length > 0 && (
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
            ...
            >
              <div className="text-center space-y-2">
                <h3 className="text-2xl serif font-semibold">
                  איך היה הטיפול?
                </h3>
...
function StorePage({
  ...
  const defaultProducts = [
    ...
    },
    {
      ...
      brand: "Aesthetics Pro",
      price: "₪120",
      img: "https://images.unsplash.com/photo-1556228578-8c89e6afd827?auto=format&fit=crop&q=80&w=400",
    },
    {
      name: "מסכת זהב 24K",
      brand: "Luxury Care",
  ...
  const displayProducts =
    catalogProducts.length > 0 ? catalogProducts : defaultProducts;
            ...
            <div className="aspect-square overflow-hidden">
              <img
                src={
                  p.img ||
                  p.imageUrl ||
                  "https://picsum.photos/seed/cosmetics/400/400"
                }
                alt={p.name}
...
function BookingPage({
  ...
  useEffect(() => {
    ...
    const loadSlots = async () => {
      ...
      try {
        ...
        toast.error("לא ניתן היה לטעון שעות פנויות לתאריך זה");
      } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!phoneRegex.test(bookingData.phone.trim())) {
      toast.error("אנא הזיני מספר טלפון נייד תקין (למשל: 0501234567)");
      return;
    }
  ...
  return (
    ...
    >
      <div className="text-center space-y-4">
        ...
        <p className="text-brand-dark/60">
          מלאי את פרטייך ובחרי את הטיפול והזמן הנוח לך
        </p>
      </div>

      <form
        onSubmit={handleSubmit}
        className="bg-white p-8 rounded-3xl border border-brand-gold/10 shadow-xl space-y-6"
      >
        ...
        <div className="space-y-4">
          ...
          <select
            ...
            onChange={(e) =>
              setBookingData({ ...bookingData, treatment: e.target.value })
            }
            className="w-full bg-brand-beige/30 border border-brand-gold/20 rounded-xl p-4 focus:outline-none focus:ring-2 focus:ring-brand-gold/30"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <select
              ...
              disabled={!bookingData.date || isFetchingSlots}
            ...
            >
              <option value="">
                {isFetchingSlots ? "טוען שעות פנויות..." : "בחרי שעה"}
              </option>
              ...
              {bookingData.date &&
                ...
                !isFetchingSlots && (
                  <option disabled>אין חלונות זמן פנויים ביום זה</option>
                )}
            </select>
          </div>
        </div>
        ...
        <button
          ...
          className="w-full bg-brand-gold text-white py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-brand-gold/90 transition-all shadow-lg disabled:opacity-50 flex items-center justify-center gap-2"
        >
          {isSubmitting ? (
            <>
...
function ProfilePage({
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      toast.error("חלה שגיאה בשמירת הנתונים. אנא נסי שוב.", {
        position: "top-center",
      });
    } finally {
      setIsSubmitting(false);
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
            ...
            >
              <div className="flex justify-between items-center mb-2">
                <h3 className="text-2xl serif font-semibold text-brand-dark">
                  עריכת פרטים אישיים
                </h3>
                <button
                  onClick={() => setIsEditing(false)}
                  className="p-2 hover:bg-brand-beige rounded-full transition-colors text-brand-dark/60"
                >
                  <X size={20} />
                </button>
              </div>
              <div className="space-y-4">
                <div className="space-y-1">
                  <label className="text-xs font-bold uppercase tracking-widest text-brand-gold">
                    שם פרטי
                  </label>
                  <input
                    type="text"
          ...
          <div className="space-y-4">
            {appointments.length === 0 ? (
              ...
              appointments.map((app) => (
                <div
                  key={app.id}
                  className="bg-white p-6 rounded-2xl border border-brand-gold/10 flex justify-between items-center"
                >
                  <div>
                    <h4 className="font-bold">{app.treatmentName}</h4>
                    <p className="text-xs text-brand-dark/60">
                      {app.date} בשעה {app.time}
                    </p>
                    <span
                      className={cn(
          ...
          <div className="space-y-4">
            {orders.length === 0 ? (
              ...
              orders.map((order) => (
                <div
                  key={order.id}
                  className="bg-white p-6 rounded-2xl border border-brand-gold/10 space-y-4"
                >
                    ...
                    {order.items &&
                      order.items.map((item: any, i: number) => {
                        ...
                        return (
                          <div
                            key={i}
                            className="group relative w-12 h-12 rounded-lg bg-brand-beige overflow-hidden flex-shrink-0 border border-brand-gold/5"
                          >
                            <img
                              src={itemImage}
                              alt={item.name}
          ...
          <div className="p-8 text-center space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {products.map((p: any) => (
                <div
                  key={p.id}
                  className="bg-brand-beige/30 p-6 rounded-2xl border border-brand-gold/10 flex justify-between items-center"
                >
                  ...
                  <tr key={review.id}>
                    ...
                    <td className="p-6 flex gap-2">
                      {review.status === "pending" && (
                        <button
                          onClick={() => onUpdateReview(review.id, "approved")}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-brand-gold text-white py-4 rounded-xl font-bold uppercase tracking-widest"
                >
                  הוסיפי טיפול
                </button>
              </div>
              <div className="space-y-4">
                ...
                {treatments.map((t: any) => (
                  <div
                    key={t.id}
                    className="flex justify-between items-center p-4 bg-brand-beige/20 rounded-2xl"
                  >
                    <div>
  ...
  return (
    ...
    >
      <div className="text-center space-y-4">
        ...
        <p className="text-brand-dark/60">
          טיפים, המלצות ומידע מקצועי מעולם האסתטיקה
        </p>
      </div>
      <div className="space-y-12">
        {posts.length === 0 ? (
          ...
          posts.map((post) => (
            <article
              key={post.id}
              className="bg-white p-8 md:p-12 rounded-[40px] border border-brand-gold/10 shadow-xl space-y-6 hover:shadow-2xl transition-shadow"
            >
              <div className="space-y-2">
                <div className="text-xs font-bold text-brand-gold uppercase tracking-widest">
                  {formatDisplayDate(post.createdAt)}
                </div>
                <h3 className="text-3xl serif font-semibold text-brand-dark">
                  {post.title}
                </h3>
              </div>
  ...
  return (
    ...
    >
      <div className="text-center space-y-4">
        ...
        <p className="text-brand-dark/60">
          התאימי את שגרת הטיפוח המושלמת עבורך בעזרת הבינה המלאכותית שלנו
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          <h3 className="text-3xl serif font-medium leading-tight">
            הכירי את אסיסטנטית היופי שלך
          </h3>
          ...
          <ul className="space-y-3 text-sm font-medium">
            <li className="flex items-center gap-2 text-brand-gold">
              <Sparkles size={16} /> התאמת מוצרים לפי סוג עור
            </li>
            <li className="flex items-center gap-2 text-brand-gold">
              <Sparkles size={16} /> המלצות על שגרת בוקר וערב
            </li>
            <li className="flex items-center gap-2 text-brand-gold">
              <Sparkles size={16} /> מענה על שאלות בנושא רכיבים פעילים
            </li>
          </ul>
          <button
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-3xl shadow-xl border border-brand-gold/10 max-w-[200px]">
            ...
            <p className="text-[10px] font-medium leading-relaxed italic">
              "הייעוץ עזר לי מאוד להבין איזה מוצרים באמת מתאימים לי. מומלץ
              בחום!"
            </p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-[40px] p-8 md:p-16 border border-brand-gold/10 shadow-2xl space-y-12">
        <div className="text-center space-y-4">
          <h3 className="text-3xl serif font-semibold">
            השאירי פרטים לייעוץ אנושי
          </h3>
          <p className="text-brand-dark/60">
            הפרטים יישמרו ישירות ב-Supabase דרך שרת ה-Backend שלנו
          </p>
        </div>

        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-6">
          <div className="space-y-2">
            <label className="text-sm font-bold uppercase tracking-widest text-brand-gold">
              שם מלא
            </label>
            <input
              type="text"
